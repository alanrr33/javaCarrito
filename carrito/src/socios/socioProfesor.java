...
public class socioProfesor extends Socios {
	
	public socioProfesor() {
		setCat("Profesor");
	}

	public socioProfesor( String nombre, String apellido, String dni, String direccion, String email,
